...
exports.OpenAccountValidator = void 0;
...
let OpenAccountValidator = class OpenAccountValidator {
    constructor(accountRepository) {
        this.accountRepository = accountRepository;
    }
    async validate(openAccountRequestDto) {
        let notification = new app_notification_1.AppNotification();
        const number = openAccountRequestDto.number.trim();
        if (number.length <= 0) {
        ...
        const accountTypeORM = await this.accountRepository.createQueryBuilder().where("number = :number", { number }).getOne();
...
OpenAccountValidator = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(account_typeorm_1.AccountTypeORM)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], OpenAccountValidator);
exports.OpenAccountValidator = OpenAccountValidator;
//# sourceMappingURL=open-account.validator.js.map