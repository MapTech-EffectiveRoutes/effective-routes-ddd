...
exports.GetAccountByIdHandler = void 0;
const cqrs_1 = require("@nestjs/cqrs");
const typeorm_1 = require("typeorm");
const get_accounts_dto_1 = require("../../dtos/queries/get-accounts.dto");
const get_account_by_id_query_1 = require("../../queries/get-account-by-id.query");
let GetAccountByIdHandler = class GetAccountByIdHandler {
    constructor() { }
    async execute(query) {
...
GetAccountByIdHandler = __decorate([
    (0, cqrs_1.QueryHandler)(get_account_by_id_query_1.GetAccountByIdQuery),
    __metadata("design:paramtypes", [])
], GetAccountByIdHandler);
exports.GetAccountByIdHandler = GetAccountByIdHandler;
//# sourceMappingURL=get-account-by-id.handler.js.map