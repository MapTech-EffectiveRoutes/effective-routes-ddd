...
exports.WithdrawMoneyValidator = void 0;
...
let WithdrawMoneyValidator = class WithdrawMoneyValidator {
    constructor(accountRepository) {
        this.accountRepository = accountRepository;
    }
    async validate(withdrawRequestDto) {
        let notification = new app_notification_1.AppNotification();
        const accountNumber = withdrawRequestDto.accountNumber.trim();
        ...
        const amount = withdrawRequestDto.amount;
        if (amount <= 0) {
...
WithdrawMoneyValidator = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(account_typeorm_1.AccountTypeORM)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], WithdrawMoneyValidator);
exports.WithdrawMoneyValidator = WithdrawMoneyValidator;
//# sourceMappingURL=withdraw-money.validator.js.map