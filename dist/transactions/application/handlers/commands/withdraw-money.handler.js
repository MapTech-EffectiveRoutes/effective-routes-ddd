...
exports.WithdrawMoneyHandler = void 0;
...
let WithdrawMoneyHandler = class WithdrawMoneyHandler {
    ...
    async execute(command) {
        ...
        const accountFrom = account_id_value_1.AccountId.of(accountTypeORM.id);
        const amount = money_value_1.Money.create(command.amount, currency_enum_1.Currency.SOLES);
        let transaction = transaction_factory_1.TransactionFactory.createFrom(transaction_type_enum_1.TransactionType.WITHDRAW, transaction_status_enum_1.TransactionStatus.STARTED, accountFrom, null, amount, null);
...
WithdrawMoneyHandler = __decorate([
    (0, cqrs_1.CommandHandler)(withdraw_money_command_1.WithdrawMoney),
...
//# sourceMappingURL=withdraw-money.handler.js.map